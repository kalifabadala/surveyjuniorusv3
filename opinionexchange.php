...
<h1 class="module-title">Generador OpinionExchange</h1>
<p class="module-subtitle">Pega la URL de la encuesta para generar tu jumper.</p>
...
<?php else: ?>
    ...
    <div class="bento-grid">
        <div class="bento-box box-generator" style="grid-column: span 12;">
            <div class="box-header">Generador OpinionExchange</div>
            
            <!-- 
                Este formulario es manejado por dashboard-script.js
                data-api="api_generate_opinionex.php" le dice al script qué API llamar.
            -->
            <form id="generator-form" class="generator-form" data-api="api_generate_opinionex.php">
                <div class="mb-3">
                    <label for="gen-url" class="form-label">URL de Encuesta</label>
                    <!-- IMPORTANTE: El 'name' es 'input_url_opinion' para coincidir con tu API -->
                    <input type="url" class="form-control-dark" id="gen-url" name="input_url_opinion" placeholder="https://survey.ejemplo.com/wix/p..." required>
                    <div class="form-text">Pega aquí la URL completa. Debe contener el parámetro 'UserID=...'.</div>
                </div>
